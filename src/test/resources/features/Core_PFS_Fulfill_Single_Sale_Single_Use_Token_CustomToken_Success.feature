@FullFil 
Feature: Single Sale , Single Use Token and Custom Taken name success

Scenario: Core_PFS_Fulfill_Single_Sale_Single_Use_Token_CustomTaken_Success
	...
	And User can can enter the token name "pfs123" in custom token name field
