@FullFil 
Feature: Fulfill ENTITLEMENT_DETAILS Unregistered email address

Scenario: Core_PFS_Fullfill_ENTITLEMENT_DETAILS_Entitle_a_returning_customer_Unregistered_email_error
	...
	When Enter the "Email" address of the customer "chari@gmail.com" who has already redeemed the tokens in the past 
	And Click on "Search_Email" button
	Then Error has to come up below the token expiration as "Try another email address or create a token to continue this entitlement without a customer email address"
